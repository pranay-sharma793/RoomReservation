...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'O2'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Williams' AND FIRST_NAME = 'Shawn'), '2020-06-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'O1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Williams' AND FIRST_NAME = 'Harold'), '2021-04-04');
